...
export default class MapDuplicateAlertPage extends React.Component{
        ...
        return(
            <SafeAreaView style={styles.main_container}>
                ...
                <View style={styles.bouton_container}>
                    <BoutonCustom text={"En effet, il s'agit bien d'un autre évènement"} color={'#3DBB41'} fontSize={20} width={250} />
                </View>
            </SafeAreaView>
        )
    }
